...
if($_SESSION['is_produtor']){
    ...
    $sql = "UPDATE infos_prod SET nome_empresa='$new_nome_empresa', email_prod='$new_email', fone_prod='$new_phone', insta_prod='$new_insta' WHERE id_prod='$prod_id'";
...
alert("Dados atualizados com sucesso");
         ...
         $_SESSION['infos_pessoa_prod']['insta_prod']= $new_insta ;
