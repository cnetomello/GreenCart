            ...
            <form action="Insert_info_produtor.php" method="post" onsubmit="return validate();">
                ...
                <div class="input-group">
                    <div class="input-box">
                        ...
                        <input id="nome_empresa" type="text" name="nome_empresa" placeholder="Digite o nome da empresa"
                            required>
                    ...
                    <div class="input-box">
                        <label style="color:white" for="insta_prod">Instagram</label>
                        <input id="instagram_prod" type="text" name="insta_prod" placeholder="Digite seu instagram"
                            required>
                    </div>
    ...
    function validate() {
        ...
        if (password.value != confirm_pass.value) {
            var confirmPasswordInput = document.querySelector(
                '.input-box input[type="password"][name="confirmPassword"]');
