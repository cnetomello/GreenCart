...
$sql = "INSERT INTO anuncio_infos(id_prod_an,nome_produto,qtd_produto,descricao,data_colheta,preco_unitario) values ('$id_prod','$nome_prod','$qtd_produto','$desc_produto','$data_colheta','$preco_produto')";
