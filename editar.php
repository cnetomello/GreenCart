    ...
    <section class="home" id="home">
        ...
        <div class="content">
            <form class="form-update-infos-anuncio" method="POST"
                ...
                style=" margin: 20px; padding: 20px; width: 100%; border: 1px solid #ccc; border-radius: 5px; background-color: #f8f8f8;">
                ...
                <input type="text" id="descricao" name="new_descricao" value="<?php echo $descricao ?>"
                    style="display: block; margin-bottom: 10px; padding: 5px; border: 1px solid #ccc; border-radius: 3px; width: 100%; box-sizing: border-box;">
                ...
                <input type="text" id="preco_unitario" name="new_preco_unitario" value="<?php echo $preco_unitario ?>"
                    style="display: block; margin-bottom: 10px; padding: 5px; border: 1px solid #ccc; border-radius: 3px; width: 100%; box-sizing: border-box;">
