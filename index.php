...
<body>
    ...
    <section class="about" id="about">
        ...
        <div class="row">
            ...
            <div class="content">
                <h3>Quem somos?</h3>
                <p>Atualmente o acesso a produtos orgânicos vem sendo cada vez mais dificultado e caro. Diante dessa
                    situação,
                    a equipe GreenCart teve a ideia de facilitar e tornar mais acessível o acesso a tais produtos, por
                    meio
    ...
    <section class="contact" id="contact">
        ...
        <div class="row">
            ...
            <form action="">
                ...
                <textarea name="" class="box" placeholder="Digite aqui sua mensagem..." id="" cols="30"
                    rows="10"></textarea>
