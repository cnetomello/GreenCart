...
if($_SESSION['is_produtor']){ ?>
        ...
        <form class="form-update-infos-produtor" method="POST" action="update_infos.php"
            onsubmit="return validar_produtor()"
            style="display: none; margin: 20px; padding: 20px; width: 30%; border: 1px solid #ccc; border-radius: 5px; background-color: #f8f8f8;">
            <label for="nome">Nome:</label>
            <input type="text" id="nome_empresa" name="new_nome_empresa" value="<?php echo $nome_empresa ?>"
            ...
            <input type="text" id="email_produtor" name="new_email" value="<?php echo $email_prod ?>"
                style="display: block; margin-bottom: 10px; padding: 5px; border: 1px solid #ccc; border-radius: 3px; width: 100%; box-sizing: border-box;">
            ...
            <input type="text" id="phone_produtor" name="new_phone" value="<?php echo $fone_prod ?>"
                style="display: block; margin-bottom: 10px; padding: 5px; border: 1px solid #ccc; border-radius: 3px; width: 100%; box-sizing: border-box;">
        ...
        <?php } else{ ?>
        <form class="form-update-infos-comprador" method="POST" action="update_infos.php"
            onsubmit="return validate_comprador()"
            style="display: none; margin: 20px; width: 30% ; padding: 20px; border: 1px solid #ccc; border-radius: 5px; background-color: #f8f8f8;">
            <label for="nome">Primeiro Nome:</label>
            <input type="text" id="first_name" name="new_first_name" value="<?php echo $first_name ?>"
                style="display: block; margin-bottom: 10px; padding: 5px; border: 1px solid #ccc; border-radius: 3px; width: 100%; box-sizing: border-box;">
            ...
            <input type="text" id="last_name" name="new_last_name" value="<?php echo $last_name ?>"
                style="display: block; margin-bottom: 10px; padding: 5px; border: 1px solid #ccc; border-radius: 3px; width: 100%; box-sizing: border-box;">
            ...
            <label for="email">E-mail:</label>
            <input type="text" id="email" name="new_email" value="<?php echo $email ?>"
                style="display: block; margin-bottom: 10px; padding: 5px; border: 1px solid #ccc; border-radius: 3px; width: 100%; box-sizing: border-box;">
            <p style="display: none; color:red;margin-bottom:10px;" id="error-email">
                *Digite um email valido<br>
            </p>
            <label for="telefone">Telefone:</label>
            <input type="text" id="phone" name="new_phone" value="<?php echo $phone ?>"
                style="display: block; margin-bottom: 10px; padding: 5px; border: 1px solid #ccc; border-radius: 3px; width: 100%; box-sizing: border-box;">
            <p style="display: none; color:red;margin-bottom:10px;" id="error-phone">
                *digite um telefone valido<br>
            </p>
        ...
        <table class="tabela-comprador">
            ...
            <tr class="label-name">
                ...
                <!-- fazem atencao um de vcs  apagaram o td  nao tava mostrando o ultimo nome -->
            </tr>
            <tr class="label-name">
                <th>Phone:</th>
